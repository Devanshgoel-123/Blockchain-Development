...
async function main(){
    try {
        ...
        console.log("SimpleStorageFactory created successfully");
        //here neither have we given the api,abi thus by default we use hardhat netwrok
        ...
        // Interactin with the smart Contract
